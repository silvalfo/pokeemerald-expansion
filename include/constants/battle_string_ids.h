...
#define STRINGID_PKMNHEALEDWITH						  665
#define STRINGID_PKMNHURTSTARGET					  666
#define STRINGID_PKMNCUTSSPATKWITH					  667
#define STRINGID_PKMNCUTHPMAXEDSPATTACK				  668
#define STRINGID_HOTAIRHPUP							  669
