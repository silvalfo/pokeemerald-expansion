...
#define FRIENDSHIP_EVENT_VITAMIN          1 // originally unused, now used by IV increasing vitamins
...
#define FLAG_PIERCING_MOVE						  (1 << 31)
...
#define SPECIES_FLAG_EEVEELUTION		(1 << 12)
