...
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_2_INSECT_PLATE  0x264 // Unused Flag
...
#define FLAG_HIDE_PETALBURG_WOODS_2_SUDOWOODO                                           0x493 // Unused Flag
...
#define FLAG_DAILY_BLANK_STONE                      (DAILY_FLAGS_START + 0x3)  // Unused Flag
