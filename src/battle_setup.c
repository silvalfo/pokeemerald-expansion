...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROXANNE_2, TRAINER_ROXANNE_2, TRAINER_ROXANNE_2, TRAINER_ROXANNE_2, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_BRAWLY_2, TRAINER_BRAWLY_2, TRAINER_BRAWLY_2, TRAINER_BRAWLY_2, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_2, TRAINER_WATTSON_2, TRAINER_WATTSON_2, TRAINER_WATTSON_2, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY_1, TRAINER_FLANNERY_2, TRAINER_FLANNERY_2, TRAINER_FLANNERY_2, TRAINER_FLANNERY_2, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_2, TRAINER_NORMAN_2, TRAINER_NORMAN_2, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_2, TRAINER_WINONA_2, TRAINER_WINONA_2, TRAINER_WINONA_2, FORTREE_CITY),
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_2, TRAINER_JUAN_2, TRAINER_JUAN_2, SOOTOPOLIS_CITY),
