...
static const s8 sAiAbilityRatings[ABILITIES_COUNT] =
{
    ...
    [ABILITY_HEALER] = 0,
    [ABILITY_HEATPROOF] = 5,
	[ABILITY_HEAVY_DUTY] = 5,
	[ABILITY_HEAVY_HITTER] = 5,
    ...
    [ABILITY_UNBURDEN] = 7,
    [ABILITY_UNNERVE] = 3,
	[ABILITY_UNRELENTING] = 5,
	[ABILITY_UNWAVERING] = 7,
