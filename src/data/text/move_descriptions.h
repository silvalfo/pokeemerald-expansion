...
static const u8 sThunderDropDescription[] = _(
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_BLAST_BURN - 1] = sPhotonGeyserDescription,
    [MOVE_HYDRO_CANNON - 1] = sPhotonGeyserDescription,
    ...
    [MOVE_FRENZY_PLANT - 1] = sPhotonGeyserDescription,
