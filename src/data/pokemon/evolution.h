...
#endif
	[SPECIES_JOLTEON]				= {{EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE}},
	[SPECIES_VAPOREON]				= { { EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE } },
	[SPECIES_FLAREON]				= { { EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE } },
	[SPECIES_ESPEON]				= { { EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE } },
	[SPECIES_UMBREON]				= { { EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE } },
	[SPECIES_GLACEON]				= { { EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE } },
	[SPECIES_LEAFEON]				= { { EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE } },
	[SPECIES_SYLVEON]				= { { EVO_ITEM, ITEM_BLANK_STONE, SPECIES_EEVEE } },
